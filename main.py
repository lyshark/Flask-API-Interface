...
def GetLocationLatFunction(mobile):
    ...
    postcontent += '<MSID_TYPE>0</MSID_TYPE>'
    postcontent += '</MSIDS>'
    postcontent += '<POSREQTYPE>2</POSREQTYPE>'
    postcontent += '<GEO_INFO>'
    postcontent += '<COORD_SYS>LL</COORD_SYS>'
    postcontent += '<DATUM>WGS-84</DATUM>'
    postcontent += '<LL_FORMAT>D9</LL_FORMAT>'
    postcontent += '</GEO_INFO>'
    postcontent += '<PQOS>'
    postcontent += '<RESP_REQ>DELAY_TOL</RESP_REQ>'
    postcontent += '<HOR_ACC>100</HOR_ACC>'
    postcontent += '<ALT_ACC>100</ALT_ACC>'
    postcontent += '</PQOS>'
